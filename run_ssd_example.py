...
if os.path.isdir(image_path):
    ...
    for img_num, img in enumerate(os.listdir(image_path)):
        if not os.path.isfile(os.path.join(image_path, img)):
            continue
        ...
        for i in range(boxes.shape[0]):
            ...
            cv2.putText(orig_image, label,
                        ...
                        (255, 0, 255),
                        2)  # line type
        path = os.path.join(pred_path, f"prediction{img_num}.jpg")
